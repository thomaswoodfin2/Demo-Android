...
//        final PlaceArrayAdapter.ViewHolder holder;
...
//        final ViewHolder holder = (ViewHolder) row.getTag();
        if (mResultList.get(position).description != null && mResultList.get(position).description.length() > 0) {
            holder.place.setText(mResultList.get(position).description);
